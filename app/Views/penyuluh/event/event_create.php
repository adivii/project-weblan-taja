...
<div class="container-fluid w-100" style="padding: 60px 100px 0 100px">
    <form action="/event/save" method="POST">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="judul_event" id="judul_event" aria-describedby="emailHelp">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" name="tempat_event" id="tempat_event"></textarea>
        </div>
